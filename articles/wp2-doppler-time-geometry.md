...
>
> In the **LEOSAR** component of the COSPASS-SARSAT system:
...
**Example 2: Doppler-Based Location in LEOSAR (COSPASS-SARSAT)**

In Doppler-based search-and-rescue systems operated under the **COSPASS-SARSAT** framework:
