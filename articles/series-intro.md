...
When an aircraft goes missing and a satellite detects a faint distress beacon, it is not just decoding a signal. It is measuring time differences at the microsecond level, frequency shifts caused by motion and spatial geometry across thousands of kilometres.
